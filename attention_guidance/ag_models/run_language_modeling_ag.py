...
from ag_utils import modify_config
...
class DataTrainingArguments:
    ...
    wandb_project: Optional[str] = field(
        default='huggingface', metadata={"help": "WANDB project to log in"}
    )
    wandb_name: Optional[str] = field(
        default='huggingface', metadata={"help": "Name of the run"}
    )
    disable_wandb: bool = field(
        default=False, metadata={"help": "If true, disables WANDB completely"}
    )      
